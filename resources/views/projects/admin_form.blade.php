...
<form action="{{ route("addProject") }}" enctype="multipart/form-data"  class="form-group col-sm-12 admin-form hide-form" id="add-item-form">
    ...
    <select class="mt-3 mb-2form-control p-4 store-select" name="status" id="store-select">
        ...
        <option value="current">ამჟამინდელი</option>
